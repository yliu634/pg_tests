...
2) Run the SQL in the `tipg-ubuntu` container (PG client inside) and check for ERROR output. NOTICE can be ignored, write output named as *.expected back to compatible folder
