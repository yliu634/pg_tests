...
DROP SEQUENCE IF EXISTS foo,
  ...
  seq_int4_start_high,
  seq_int4_min_low,
  seq_int4_max_high_desc,
  seq_int4_min_high_desc,
  reverse_direction_seqas,
  restart_seq,
  restart_min_err_seqas,
  restart_max_err_seqas,
  set_no_maxvalue,
  set_no_minvalue,
  seq_inverse_no_change,
  seq_change_type_bounds,
  seq_alter_no_min_max_asc,
  seq_alter_no_min_max_des,
  test_52552_asc,
  test_52552_desc,
  test_52552_start;

-- Helper view to inspect sequence definitions.
CREATE TEMP VIEW show_sequences AS
SELECT schemaname,
       sequencename,
       sequenceowner,
       data_type,
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'foo';
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_as';
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_int4_max_high';

-- Test 26: statement (line 117)
ALTER SEQUENCE seq_int4_max_high MAXVALUE 32000;
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_int4_min_high';

-- Test 31: statement (line 136)
ALTER SEQUENCE seq_int4_min_high MINVALUE 32000 START WITH 32000 RESTART WITH 32000;
...
ALTER SEQUENCE seq_int4_start_high START WITH 32000 RESTART WITH 32000;
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_int4_start_high';

-- Test 38: statement (line 161)
CREATE SEQUENCE seq_int4_min_low AS int4 MINVALUE -99999;

-- Test 39: query (line 164)
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_int4_min_low';

-- Test 40: statement (line 169)
ALTER SEQUENCE seq_int4_min_low MINVALUE -32000 START WITH -32000 RESTART WITH -32000;
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_int4_max_high_desc';

-- Test 45: statement (line 188)
ALTER SEQUENCE seq_int4_max_high_desc MAXVALUE 32000 START WITH 32000 RESTART WITH 32000;
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_int4_min_high_desc';

-- Test 50: statement (line 207)
ALTER SEQUENCE seq_int4_min_high_desc MINVALUE -32000;
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'reverse_direction_seqas';
...
CREATE SEQUENCE set_no_maxvalue MAXVALUE 3 CYCLE;
...
CREATE SEQUENCE set_no_minvalue INCREMENT -1 MINVALUE -3 CYCLE;
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_inverse_no_change';
...
ALTER SEQUENCE seq_change_type_bounds MINVALUE -32768 MAXVALUE 32767 START WITH 0 RESTART WITH 0;

-- Test 87: statement (line 355)
ALTER SEQUENCE seq_change_type_bounds AS smallint;

-- Test 88: query (line 358)
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_change_type_bounds';
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_alter_no_min_max_asc';
...
SELECT * FROM show_sequences WHERE schemaname = 'public' AND sequencename = 'seq_alter_no_min_max_des';

-- Test 97: statement (line 401)
CREATE SEQUENCE test_52552_asc INCREMENT BY 3 MINVALUE 1 MAXVALUE 100;
...
CREATE SEQUENCE test_52552_desc INCREMENT BY -5 MINVALUE -100 MAXVALUE 12;
