...
-- COMMENTED: Logic test directive: let $v_id
...
-- COMMENTED: Logic test directive: let $seq_id
...
-- COMMENTED: Logic test directive: let $num_ref_hidden_id
