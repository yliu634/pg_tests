...
DROP TABLE IF EXISTS t95560a CASCADE;
DROP TABLE IF EXISTS t95560b CASCADE;
RESET client_min_messages;

-- Test 1: query (line 1)
-- IF() is MySQL syntax, converting to CASE
SELECT CASE WHEN 1 = 2 THEN NULL ELSE 1 END, CASE WHEN 2 = 2 THEN NULL ELSE 2 END;
...
SELECT a, NULLIF(a, 2), CASE WHEN a = 2 THEN NULL ELSE a END FROM t ORDER BY a;
