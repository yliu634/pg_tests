...
CREATE TABLE fk(
    f INT REFERENCES kv ON DELETE CASCADE
);

-- Test 3: statement (line 22)
INSERT INTO kv VALUES (1, 2) ON CONFLICT (k) DO NOTHING;

-- Test 4: statement (line 25)
INSERT INTO kv VALUES (1, 2) ON CONFLICT (k) DO NOTHING;

-- Test 5: statement (line 28)
INSERT INTO kv VALUES (2, 2) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;

-- Test 6: statement (line 31)
INSERT INTO kv VALUES (2, 50) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;

-- Test 7: statement (line 34)
UPDATE kv SET v = k WHERE k = 3;

-- Test 8: statement (line 37)
UPDATE kv SET k = 1 WHERE k = 2 AND NOT EXISTS (SELECT 1 FROM kv WHERE k = 1);
...
INSERT INTO kv VALUES (2, 3) ON CONFLICT (k) DO NOTHING;

-- Test 17: statement (line 67)
INSERT INTO kv VALUES (3, 4) ON CONFLICT (k) DO NOTHING;
...
INSERT INTO kv VALUES (4, 5) ON CONFLICT (k) DO NOTHING;

-- Test 22: statement (line 88)
INSERT INTO kv VALUES (2, 3) ON CONFLICT (k) DO NOTHING;

-- Test 23: statement (line 91)
INSERT INTO kv VALUES (5, 6) ON CONFLICT (k) DO NOTHING;

-- Test 24: statement (line 94)
COMMIT;

-- Test 25: query (line 97)
SELECT 'OK' AS transaction_status;
...
INSERT INTO kv VALUES (1, 7) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;

-- Test 29: statement (line 118)
INSERT INTO kv VALUES (4, 8) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;

-- Test 30: statement (line 121)
INSERT INTO kv VALUES (3, 9) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;
...
INSERT INTO kv VALUES (1, 8) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;

-- Test 35: statement (line 143)
INSERT INTO kv VALUES (4, 50) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;

-- Test 36: statement (line 146)
INSERT INTO kv VALUES (3, 10) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;
...
UPDATE kv SET v = k WHERE k = 1;

-- Test 41: statement (line 169)
UPDATE kv SET v = k WHERE k = 3;

-- Test 42: statement (line 172)
UPDATE kv SET v = k WHERE k = 9;
...
UPDATE kv SET k = 9 WHERE k = 1 AND NOT EXISTS (SELECT 1 FROM kv WHERE k = 9);

-- Test 47: statement (line 194)
UPDATE kv SET k = 3 WHERE k = 2 AND NOT EXISTS (SELECT 1 FROM kv WHERE k = 3);

-- Test 48: statement (line 197)
UPDATE kv SET k = 10 WHERE k = 4 AND NOT EXISTS (SELECT 1 FROM kv WHERE k = 10);
...
INSERT INTO kv VALUES (5, 9) ON CONFLICT (k) DO NOTHING;

-- Test 67: query (line 275)
SELECT k, v FROM kv ORDER BY k;

-- Test 68: statement (line 284)
INSERT INTO kv VALUES (6, 10) ON CONFLICT (k) DO UPDATE SET v = EXCLUDED.v;

-- Test 69: statement (line 287)
UPDATE kv SET v = k+1 WHERE k = 3;
...
INSERT INTO kv VALUES (7, 7) ON CONFLICT (k) DO NOTHING;
...
PREPARE x AS INSERT INTO kv VALUES ($1, $2) ON CONFLICT (k) DO NOTHING;
