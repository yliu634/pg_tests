...
SELECT ('12:00:00' COLLATE "C")::TIME;
...
INSERT INTO arrays VALUES
  (ARRAY[]::TIME[]),
  (ARRAY['00:00:00']::TIME[]),
  (ARRAY['00:00:00', '12:00:00.000001']::TIME[]),
  ('{13:00:00}'::TIME[]);
...
select column_name, data_type FROM information_schema.columns WHERE table_schema = current_schema() AND table_name = 'time_precision_test' ORDER BY column_name;
...
SELECT '00:01:40.01+09:00:00' < (col::TIMETZ + '-83 years -1 mons -38 days -10:32:23.707137'::interval)
