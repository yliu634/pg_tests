...
WHERE c.relname = 'timetz_precision_test'
...
SELECT '2001-01-01 01:24:00+3'::timestamptz::timetz;
...
SELECT '09:00:00.456-07' COLLATE "C"::TIMETZ;
...
INSERT INTO tzarrays VALUES
  (ARRAY[]::TIMETZ[]),
  (ARRAY['00:00:00-07']::TIMETZ[]),
  (ARRAY['00:00:00-07', '12:00:00.000001-07']::TIMETZ[]),
  ('{13:00:00-07}'::TIMETZ[]);
...
SELECT f1 + interval '1 minute' AS "PlusInterval" FROM TIMETZ_TBL ORDER BY id;
...
SELECT count(*) FROM regression_74912 WHERE t1 > '05:00:00';

-- Test 96: query (line 692)
SELECT count(*) FROM regression_74912 WHERE t1 < '05:00:00.000001';
