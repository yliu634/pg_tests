...
-- PostgreSQL doesn't support CockroachDB `SET database`; approximate with schema + search_path.
...
SELECT current_schema() AS database;
...
SET search_path = foo, public; CREATE TABLE bar (k INT PRIMARY KEY);
