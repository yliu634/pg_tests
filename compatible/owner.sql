...
DROP TABLE IF EXISTS for_view CASCADE;
...
-- COMMENTED: Logic test directive: user testuser2
...
-- COMMENTED: Logic test directive: let $testuser_job_id
SELECT id FROM system.jobs WHERE owner = 'testuser' LIMIT 1;

-- COMMENTED: Logic test directive: let $testuser2_job_id
SELECT id FROM system.jobs WHERE owner = 'testuser2' LIMIT 1;

-- COMMENTED: Logic test directive: let $node_job_id
...
-- COMMENTED: Logic test directive: user testuser3
