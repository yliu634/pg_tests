...
DROP TABLE IF EXISTS test_kv CASCADE;
DROP TABLE IF EXISTS test_kvr1 CASCADE;
DROP TABLE IF EXISTS test_kvr2 CASCADE;
DROP TABLE IF EXISTS test_kvr3 CASCADE;
DROP TABLE IF EXISTS test_kvi1 CASCADE;
DROP TABLE IF EXISTS test_kvi2 CASCADE;
DROP TABLE IF EXISTS test_uwi_parent CASCADE;
DROP TABLE IF EXISTS test_uwi_child CASCADE;
...
SET client_min_messages = warning;
DROP TABLE IF EXISTS moretest_t CASCADE;
RESET client_min_messages;
