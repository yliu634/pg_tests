...
SELECT(TIMESTAMP '2000-01-01 01:00:00',
...
SELECT(TIMESTAMP '2000-01-01 00:30:00',
TIMESTAMP '2000-01-01 00:30:00')
OVERLAPS
(TIMESTAMP '2000-01-01 00:30:00',
TIMESTAMP '2000-01-01 01:30:00');
...
SELECT(TIMESTAMPTZ '2000-01-01 00:00:00',
...
SELECT(TIMESTAMPTZ '2000-01-01 01:00:00',
...
SELECT(TIMESTAMPTZ '2000-01-01 00:30:00',
TIMESTAMPTZ '2000-01-01 00:30:00')
OVERLAPS
(TIMESTAMPTZ '2000-01-01 00:30:00',
TIMESTAMPTZ '2000-01-01 01:30:00');
...
SELECT(TIME '2000-01-01 01:00:00',
...
SELECT(TIME '2000-01-01 00:30:00',
TIME '2000-01-01 00:30:00')
OVERLAPS
(TIME '2000-01-01 00:30:00',
TIME '2000-01-01 01:30:00');
...
SELECT(TIMETZ '2000-01-01 00:00:00',
...
SELECT(TIMETZ '2000-01-01 01:00:00',
...
SELECT(TIMETZ '2000-01-01 00:30:00',
TIMETZ '2000-01-01 00:30:00')
OVERLAPS
(TIMETZ '2000-01-01 00:30:00',
TIMETZ '2000-01-01 01:30:00');
...
SELECT (NULL::timestamp, INTERVAL '1 day') overlaps (NULL::timestamp, NULL::interval);

-- Test 43: query (line 421);
SELECT (DATE '2000-01-01'::timestamp, INTERVAL '1 day') overlaps (NULL::timestamp, NULL::interval);

-- Test 44: query (line 426);
SELECT (DATE '2000-01-01', NULL::date) overlaps (DATE '2000-01-01', DATE '2000-01-02');
