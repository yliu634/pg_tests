...
CREATE TABLE test_table (col1 TEXT, col2 TEXT, col3 TEXT);
...
-- CockroachDB: SHOW CREATE <view>
SELECT
  'test_table_view' AS table_name,
  'CREATE VIEW test_table_view (col1, col2) AS ' ||
    pg_get_viewdef('test_table_view'::regclass, true) AS create_statement;
