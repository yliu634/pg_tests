...
INSERT INTO testing(k, v) VALUES (1, 'a'), (2, 'b');

-- Test 1: statement (line 4)
SET crdb.autocommit_before_ddl = off;

-- Test 2: statement (line 13)
BEGIN TRANSACTION ISOLATION LEVEL SERIALIZABLE;

-- Test 3: statement (line 16)
ALTER TABLE testing ADD CONSTRAINT unique_values_1 UNIQUE(v);
...
SET crdb.strict_ddl_atomicity = true;

-- Test 10: statement (line 50)
BEGIN TRANSACTION ISOLATION LEVEL SERIALIZABLE;

-- Test 11: statement (line 53)
ALTER TABLE testing ADD CONSTRAINT unique_values_2 UNIQUE(v);
...
SELECT 1; ALTER TABLE testing ADD CONSTRAINT unique_values_3 UNIQUE(v);

-- onlyif config weak-iso-level-configs

-- Test 15: statement (line 67)
SELECT 1; ALTER TABLE testing ADD CONSTRAINT unique_values_4 UNIQUE(v);
