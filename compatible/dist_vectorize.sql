...
DROP TABLE IF EXISTS kw CASCADE;
DROP TABLE IF EXISTS t1 CASCADE;
DROP TABLE IF EXISTS t66306 CASCADE;
...
CREATE TABLE t66306(s TEXT COLLATE "en-US-x-icu");
INSERT INTO t66306 VALUES ('test');
SELECT 1::INT2, s FROM t66306;
...
EXPLAIN SELECT 1::INT2, s FROM t66306;
