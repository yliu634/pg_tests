...
CREATE INDEX secondary_desc ON metric_values_desc (metric_id, nullable DESC, time DESC);

-- Test 5: statement (line 45)
insert into metric_values_desc select * from metric_values;

-- Test 6: statement (line 49)
-- COMMENTED: CockroachDB-specific INJECT STATISTICS; ANALYZE is the closest equivalent.
