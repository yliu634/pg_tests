...
-- Test 2: query (line 9)
SELECT jsonb_typeof('-123.4'::JSONB);
...
SELECT to_json('\a'::TEXT COLLATE "fr-FR-x-icu");
...
SELECT to_jsonb('\a'::TEXT COLLATE "fr-FR-x-icu");
...
SELECT json_agg(ROW(3808362714));
